...
//     setLanguage(newLang);
//     localStorage.setItem(`code_${userId}_${id}_${language}`, newCode);
...
// const handleLanguageChange = (newLang) => {
//   localStorage.setItem(`code_${userId}_${id}_${language}`, code);
  
//   setLanguage(newLang);
  
//   const savedCodeForNewLang = localStorage.getItem(
//     `code_${userId}_${id}_${newLang}`
//   );
//   setCode(savedCodeForNewLang || STARTER_CODE[newLang]);
// };
...
//               [instance target id: {id}. inject scripts inside isolated runtime
//               limits.]
//             </p>
//           </div>
...
//                       ? "bg-lime-400 dark:bg-emerald-500 text-black"
//                       : problem.difficulty?.toLowerCase() === "medium"
//                         ? "bg-orange-400 dark:bg-amber-500 text-black"
...
//                     <div
//                       key={tc._id || index}
//                       className="border-2 border-zinc-900 dark:border-zinc-800 bg-stone-100 dark:bg-zinc-900 p-4"
//                     >
...
//                         <div>
//                           <span className="text-xs font-black text-zinc-600 dark:text-zinc-400 uppercase block mb-1">
//                             feed input
//                           </span>
...
//                 <div>
//                   <h3 className="text-lg font-black uppercase text-zinc-900 dark:text-white tracking-tight">
//                     WORKSPACE LOGIC
//                   </h3>
//                   <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 lowercase">
//                     [execution terminal interface]
//                   </p>
//                 </div>
//                 <select
//                   value={language}
...
//                     <Terminal
//                       size={16}
//                       className="text-pink-800 stroke-[2.5]"
//                     />{" "}
//                     STANDALONE CONSOLE STACK BUFFER
//                   </h3>
...
//               {verdict && (
//                 <div
//                   className={`p-4 border-4 border-zinc-900 dark:border-black shadow-[2px_2px_0px_0px_#000] ${
//                     verdict === "Accepted"
...
//                   {failedTestCase !== null && (
//                     <p
//                       className={`mt-1 text-base font-black uppercase tracking-wider ${
//                         verdict === "Accepted"
//                           ? "text-zinc-800"
//                           : "text-zinc-100"
//                       }`}
//                     >
//                       [runtime crash pipeline error flagged on step segment
//                       index #{failedTestCase}]
//                     </p>
//                   )}
//                 </div>
//               )}
...
//                     <ShieldAlert size={16} className="stroke-[2.5]" /> SYSTEM
//                     CORE ENGINE CRASH DUMP:
//                   </span>
